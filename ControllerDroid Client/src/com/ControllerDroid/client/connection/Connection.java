...
import com.ControllerDroid.client.activity.connection.ConnectionEditActivity;
...
public abstract class Connection implements Comparable<Connection>, Serializable
{
	...
	{
		this.name = "";
		this.password = ControllerDroidConnection.DEFAULT_PASSWORD;
	}
	...
	public abstract ControllerDroidConnection connect(ControllerDroid application) throws IOException;
